...
namespace Devops_Prebuild {
    class Html {
        internal static string CreateHtml(string temp1,string appName,string PublisherName,string rarName) {
            StringBuilder builder = new StringBuilder();
            builder.Append("<HTML>\r\n");
            builder.Append("  <HEAD>\r\n");
            builder.Append("    <TITLE>" + appName + "</TITLE>\r\n");
            ...
            builder.Append("<TR><TD><TABLE CELLPADDING=\"2\" CELLSPACING=\"0\" BORDER=\"0\" BGCOLOR=\"#cecece\" WIDTH=\"100%\"><TR><TD><TABLE BGCOLOR=\"#1c5280\" WIDTH=\"100%\" CELLPADDING=\"0\" CELLSPACING=\"0\" BORDER=\"0\"><TR><TD CLASS=\"Banner\" /></TR><TR><TD CLASS=\"Banner\"><SPAN CLASS=\"BannerTextCompany\">" + PublisherName +"</SPAN></TD></TR><TR><TD CLASS=\"Banner\"><SPAN CLASS=\"BannerTextApplication\">" + appName + "</SPAN></TD></TR><TR><TD CLASS=\"Banner\" ALIGN=\"RIGHT\" /></TR></TABLE></TD></TR></TABLE></TD></TR>\r\n");
            ...
            builder.Append("<TABLE><TR><TD COLSPAN=\"3\">&nbsp;</TD></TR><TR><TD><B>名称: </B></TD><TD WIDTH=\"5\"><SPACER TYPE=\"block\" WIDTH=\"10\" /></TD><TD>" + appName + "</TD></TR><TR><TD COLSPAN=\"3\">&nbsp;</TD></TR><TR><TD><B>版本: </B></TD><TD WIDTH=\"5\"><SPACER TYPE=\"block\" WIDTH=\"10\" /></TD><TD>").Append(temp1).Append("</TD></TR><TR><TD COLSPAN=\"3\">&nbsp;</TD></TR><TR><TD><B>发行者: </B></TD><TD WIDTH=\"5\"><SPACER TYPE=\"block\" WIDTH=\"10\" /></TD><TD>" + PublisherName + "</TD></TR><tr><td colspan=\"3\">&nbsp;</td></tr><TR><TD><B>发布时间: </B></TD><TD WIDTH=\"5\"><SPACER TYPE=\"block\" WIDTH=\"10\" /></TD><TD>" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "</TD></TR><tr><td colspan=\"3\">&nbsp;</td></tr></TABLE>\r\n");
            ...
            builder.Append("如果已经安装了这些组件，您可以立即<SPAN CLASS=\"JustThisApp\"><A HREF=\"" + rarName + "\">启动</A></SPAN>该应用程序。否则，请单击下面的按钮，安装系统必备组件并运行该应用程序。\r\n");
            builder.Append("</TD></TR><TR><TD COLSPAN=\"2\">&nbsp;</TD></TR></TABLE>\r\n");
            builder.Append("<!-- End Prerequisites -->\r\n");
            builder.Append("</TD></TR></TABLE>\r\n");
            builder.Append("<!-- Begin Buttons -->\r\n");
            builder.Append("<TR><TD ALIGN=\"LEFT\"><TABLE CELLPADDING=\"2\" CELLSPACING=\"0\" BORDER=\"0\" WIDTH=\"540\" STYLE=\"cursor:hand\" ONCLICK=\"window.navigate(InstallButton.href)\"><TR><TD ALIGN=\"LEFT\"><TABLE CELLPADDING=\"1\" BGCOLOR=\"#333333\" CELLSPACING=\"0\" BORDER=\"0\"><TR><TD><TABLE CELLPADDING=\"1\" BGCOLOR=\"#cecece\" CELLSPACING=\"0\" BORDER=\"0\"><TR><TD><TABLE CELLPADDING=\"1\" BGCOLOR=\"#efefef\" CELLSPACING=\"0\" BORDER=\"0\"><TR><TD WIDTH=\"20\"><SPACER TYPE=\"block\" WIDTH=\"20\" HEIGHT=\"1\" /></TD><TD><A ID=\"InstallButton\" HREF=\"" + rarName + "\">安装</A></TD><TD width=\"20\"><SPACER TYPE=\"block\" WIDTH=\"20\" HEIGHT=\"1\" /></TD></TR></TABLE></TD></TR></TABLE></TD></TR></TABLE></TD><TD WIDTH=\"15%\" ALIGN=\"right\" /></TR></TABLE></TD></TR>\r\n");
        ...
        internal static string CreateConfig(string vbsName) {
            StringBuilder builder = new StringBuilder();
            builder.Append("Setup = ").Append(vbsName).Append("\r\n");
            builder.Append("TempMode\r\n");
            builder.Append("Silent = 1\r\n");
            builder.Append("Overwrite = 1\r\n");
            builder.Append("Update = U");
            return builder.ToString();
        }
